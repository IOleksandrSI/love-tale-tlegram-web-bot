...
export const GameConfig: { [key in ChaptersEnum]: {
  ...
  [ChaptersEnum.PUZZLE_3]: {
    ...
    icon: GiPuzzle,
    chapterDate: 'Липень 2020 - Лютий 2022',
  ...
  [ChaptersEnum.WAY_4]: {
    ...
    icon: MdAltRoute,
    chapterDate: 'Лютий 2022 - Липень 2022',
  ...
  [ChaptersEnum.GARDEN_CHANCE_6]: {
    ...
    icon: GiSeedling,
    chapterDate: 'Травень 2023 - Грудень 2024',
